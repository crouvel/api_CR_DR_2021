...
const mapjson = async (JSobjectjson) => {
    return new Promise((resolve, reject) => {
        ...
        connection.query('INSERT INTO Records (recordid,gc_obo_nature_c,gc_obo_gare_origine_r_name,date,gc_obo_nom_recordtype_sc_c,gc_obo_type_c,gc_obo_gare_origine_r_code_uic_c) VALUES ?', [values], function(err,result) {
          if(err) {
             res.send('Error');
          }
         else {
